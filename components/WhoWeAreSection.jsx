      ...
      <div className="relative z-10 max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 w-full py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-4 space-y-16 sm:space-y-24 lg:space-y-64 text-center lg:text-left">
            <div className="max-w-[380px] mx-auto lg:mx-0 transition-all duration-300 hover:scale-[1.07]">
            ...
            <div className="max-w-[280px] mx-auto lg:mx-0 lg:ml-16 transition-all duration-300 hover:scale-[1.07]">
              <h3 className="text-red-600 font-extrabold text-xl">
                Train. Fuel. Dominate.
              </h3>

              <p className="text-white/90  uppercase text-xs sm:text-xs leading-[1.6] tracking-[0.08em] font-bold uppercase  hover:text-white">
                Promolecules™ is a high-end sports nutrition brand for serious
                athletes and anyone who love to work out. Our formulations are
                based on research, honesty, and actual results, which will help
                you on your way to being physically and mentally great.
              </p>
            </div>
          </div>
    ...
    leading-none text-center"
            ...
            <div className="max-w-4xl mx-auto lg:mx-0 space-y-6 text-center lg:text-left">
              <p className="text-white/90  uppercase text-xs sm:text-xs leading-[1.6] tracking-[0.08em] font-bold uppercase  hover:text-white">
                ...
                goal is simple: to make science-based formulae that are
                incredibly strong and help you push harder, lift heavier, stay
                focused longer, and break past all your limits.
              </p>

              {/* Button */}
              <div className="pt-4 flex justify-center lg:justify-start">
                <Link href={"/about"}>
                  <button className="group flex cursor-pointer items-center gap-4 border-2 border-white/20 hover:border-red-600 text-white px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-full transition-all duration-300 hover:bg-red-600/10">
