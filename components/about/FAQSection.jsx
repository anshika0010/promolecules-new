...
const faqs = [
  {
    question:
      "WHY DO MOST PREWORKOUTS IN THE INDIAN MARKET STOP WORKING AFTER 1-2 WEEKS?",
  ...
  {
    question:
      "WHY DO SOME PREWORKOUTS CAUSE EXTREME CRASHING AND ANXIETY?",
  ...
  {
    question:
      "ARE HIGH-STIMULANT PREWORKOUTS DANGEROUS FOR THE HEART?",
    answer:
  ...
  {
    question:
      "WHY DO SOME TEST-BOOSTING PREWORKOUTS FAIL TO IMPROVE PERFORMANCE AT ALL?",
    answer:
