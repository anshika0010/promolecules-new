    ...
    <section className="relative w-full min-h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto 
        ...
        <div className="relative group">
          ...
          {/* Bottom Caption */}
          <p className="absolute bottom-4 sm:bottom-6 left-4 
        ...
        <div className="relative group">
          ...
          <div className="relative 
                          h-[400px] sm:h-[550px] md:h-[700px] lg:h-[800px] 
          ...
          {/* Bottom Caption */}
          <p className="absolute bottom-4 sm:bottom-6 
                        left-1/2 -translate-x-1/2 
                        text-[9px] sm:text-[10px] md:text-xs 
                        text-white uppercase tracking-widest 
                        text-center max-w-[200px] sm:max-w-xs">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-4 sm:top-6 right-4 sm:right-6 
                          ...
                          border-2 border-red-600 clip-hexagon opacity-80" />
