  ...
  return (
    <>
      <div className="bg-black text-white font-sans overflow-x-hidden">
        ...
        <section
          id="partners"
          className="py-16 sm:py-20 lg:py-24 relative overflow-hidden px-4 sm:px-8 lg:px-16 xl:px-24"
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <p className="max-w-2xl mx-auto mt-6 text-zinc-400 leading-7">
                No scripts. No paid actors. Just genuine reactions from
                athletes, bodybuilders, and fitness enthusiasts who train with
                Promolecules.
              </p>
            </div>
              ...
              <div className="group rounded-2xl overflow-hidden bg-zinc-900 border border-zinc-800 hover:border-red-600 transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="p-5">
                  <h3 className="text-white font-bold">
                    First Scoop Experience
                  </h3>

                  <p className="text-zinc-400 text-sm mt-2">
                    Watch the instant reaction after trying Promolecules
