    ...
    <>
      ...
      >
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
          ...
          <div className="hidden lg:flex flex-row items-center justify-between gap-10">
            ...
            <div className="flex-1 space-y-6 text-left">
              <AnimatePresence mode="wait">
                ...
                >
                  <h1 className="text-4xl md:text-5xl font-bold creepster-regular text-red-600 uppercase">
                    {activeProduct.title}
                  </h1>
          ...
          {/* ── MOBILE / TABLET LAYOUT (<lg): thumbnails → image → text ── */}
          <div className="flex lg:hidden flex-col items-center gap-6 w-full">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h1 className="text-3xl xs:text-4xl sm:text-5xl font-bold creepster-regular text-red-600 uppercase">
                  {activeProduct.title}
                </h1>
