...
export default function ProductDetail({ product }) {
  ...
  const productUrl =
    product.liveUrl || "https://www.promolecules.com/father-of-insane";
  ...
  return (
    <>
      ...
      {/* ── Main Product Layout ── */}
      <div className="min-h-screen bg-gradient-to-br from-black via-[#111] to-[#0d0d0d] text-white flex items-center justify-center p-5 mt-8 font-barlowCondensed">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* LEFT IMAGES */}
          <div className="flex flex-col gap-3 md:sticky md:top-7 h-fit self-start">
            <div className="relative flex items-center justify-center h-[400px] md:h-[600px] overflow-hidden border border-gray-300 rounded">
              ...
              <Image
                ...
                width={400}
                height={400}
                className="h-[320px] md:h-[640px] w-full rounded object-cover relative z-10 transition-all duration-500 ease-in-out"
              />
            </div>
      ...
      {/* ── Accordion Section ── */}
      <section className="max-w-7xl mx-auto bg-black text-white py-16 px-3 lg:px-2">
